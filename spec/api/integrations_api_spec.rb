...
describe 'Integrations API' do
  ...
  it 'should return error message when user is invalid' do
    ...
    expect {
      @json = api_get 'integrations', {token: integration.user.api_key.token}
    }.not_to raise_error
  ...
  it 'should not return other users\' integrations' do
    user1 = create :user
    user2 = create :user
    2.times { create(:integration, user: user1) }
    3.times { create(:integration, user: user2) }
  ...
  it 'should return an error when trying to remove other usere\'s integration' do
    my_integration = create :integration, user: create(:user)
    other_integration = create :integration, user: create(:user)
